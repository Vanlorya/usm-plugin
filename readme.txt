...
= 1.3.0 =
* **Avatar Initials** — Colored circle with first letter on Students, Coaches, Enrollments
* **Compact Icon Actions** — Icon-only buttons with hover tooltips (Enrollments)
* **Course Filter** — Dropdown to filter enrollments by course
* **Summary Stats** — Total fees collected + low-session count below enrollment table
* **Auto-dismiss Notices** — Success messages fade out after 5 seconds
* **Settings Version Info** — Version badge with GitHub and update-check links
